    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Data <b>Produk</b></h2></div>
                    <div class="col-sm-4">
                    </div>
                </div>
            </div>
            <p><a href="insert_produk.php" class="tambah" title="Tambah" data-toggle="tooltip">+ Tambah Data Produk</a></p>
            ...
            <thead>
<tr>
<th>ID Produk</th> <th>Nama Produk</th> <th>Harga</th> <th>Stok</th> <th>OPSI</th>
<?php
include "koneksi.php";
$tampil = "";
if (isset($_POST['cari'])) {
...
foreach ($tampil as $row) {
 ...
 <td><?php echo $row['Stok']; ?></td>
                    ...
                    <td>
                    <a href="update_produk.php?ProdukID=<?php echo $row['ProdukID']?>">Edit</a> |
                    <a href="delete_produk.php?ProdukID=<?php echo $row['ProdukID']?>">Delete</a>
 </td>
                    </tr>
                <?php
                }
