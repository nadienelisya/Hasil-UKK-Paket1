    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Detail <b>Penjualan</b></h2></div>
                    <div class="col-sm-4">
                    </div>
                </div>
            </div>
            <p><a href="jualbeli.php" class="tambah" title="Tambah" data-toggle="tooltip">+ Tambah Data</a></p>
            <table class="table table-striped table-hover table-bordered">
            <form action="" method="post">
              Cari berdasarkan
              <select name="pilih">
                <option value="DetailID">Id Detail</option>
                <option value="PenjualanID">Id Penjualan</option>
                <option value="ProdukID">Id Produk</option>
...
<th>ID Detail</th> <th>ID Penjualan</th> <th>ID Produk</th> <th>Jumlah Produk</th> <th>Sub Total</th> <th>OPSI</th>
 ...
 <td><?php echo $row['SubTotal']; ?></td>
                        ...
                        <td>
                        <a href="update_detail.php?DetailID=<?php echo $row['DetailID']?>">Edit</a> |
                        <a href="delete_detail.php?DetailID=<?php echo $row['DetailID']?>">Delete</a>
                        </td>
                    </tr>   
                </tbody>
                <?php
            ...
            <p><a href="penjualan.php" class="penjualan" title="Penjualan" data-toggle="tooltip">Penjualan</a></p>
